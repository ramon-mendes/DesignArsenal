...
if [ -z "$1" ]; then
    ...
    BUILD_PROJ_DIR=/Users/midiway/Documents/DesignArsenal/DesignArsenal
    BUILD_TARGET_DIR=/Users/midiway/Documents/DesignArsenal/DesignArsenal/bin/Release
fi

CONTENTS_DIR=$BUILD_TARGET_DIR/DesignArsenal.app/Contents
SHARED_DIR=$BUILD_TARGET_DIR/DesignArsenal.app/Contents/Shared
