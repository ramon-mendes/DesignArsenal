...
namespace SkiaDraw
{
	class Program
	{
		...
		static void Main(string[] args)
		{
			if(IntPtr.Size == 4)
			{
				Debug.Assert(false, "sciter.dll that comes bundled in SkiaDraw is the x64 version, make sure to change it to the x86 version if building for x86 (Windows only)");
			}
